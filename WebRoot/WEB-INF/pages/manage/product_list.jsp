...
<div id="right">
			...
			<s:iterator value="pageModel.list">
					<tr>
						...
						<td width="120" align="center">
						  <s:a action="product_edit" namespace="/pages">
						...
						<td width="52" align="center">
							<s:a action="product_del"	namespace="/pages">
  ...
  <div id="right_foot01">
	<s:url var="first" action="product_list" namespace="/pages">
		<s:param name="pageNo" value="1"></s:param>
	</s:url> 
	<s:url var="previous" action="product_list" namespace="/pages">
		<s:param name="pageNo" value="pageModel.pageNo-1"></s:param>
	</s:url> 
	<s:url var="last" action="product_list" namespace="/pages">
		<s:param name="pageNo" value="pageModel.bottomPageNo"></s:param>
	</s:url> 
	<s:url var="next" action="product_list" namespace="/pages">
		<s:param name="pageNo" value="pageModel.pageNo+1"></s:param>
	</s:url> 
